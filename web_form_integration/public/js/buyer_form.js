frappe.ready(() => {
    ...
    // ✅ Attach validation-aware submit handler
    ...
    form.addEventListener("submit", async (e) => {
        ...
        const uploadFile = async (id) => {
            ...
            if (fileInput && fileInput.files.length > 0) {
                ...
                // Reject if file is larger than 20MB
                ...
                // handle both nested + direct responses
        ...
        const data = {
            ...
            custom_architectural_quote:getCheck("custom_architectural_quote") ? 1 : 0,
